...
| `node Web/tests/lauf.mjs` | 36 Prüfungen der Web-Fassung: Musterlösungen, gleichwertige Lösungen, abgelehnter Unfug, Tipps, zweite Tipps, benannte Abweichungen, Bestehensgrenze, Karteikasten-Pausen, Ränge, Sterne, Score, Einstufung, Sicherung, Befehlslexikon (jeder Befehl in allen 4528 erklärten Zeilen hat eine Bedeutung, Sonderzeichen werden maskiert) und ob die Versionsnummer zum ausgelieferten Inhalt passt – dieselben Zahlen wie in den Swift- und Kotlin-Reihen |
...
| Windows-App: `./gradlew test` | 73 Tests bestanden (68 Logik/Speicherung, 5 Klick-Durchläufe der echten Oberfläche mit Screenshots) – darunter dieselben Werte für das verteilte Wiederholen wie auf Apple-Geräten |
