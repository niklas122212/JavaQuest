...
- **Inhalt:** 13 Module, 32 Lektionen, 170 Lektionsaufgaben + 545 Übungsaufgaben im Pool (715 übbar),
  ...
  adaptive Einstufung aus 15 Fragen, 4830 erklärte Codezeilen, Befehlslexikon mit 258 Einträgen (Deutsch),
...
| `Tools/verify_java_content.py` mit OpenJDK 25 | 702/702 Java-Prüfungen (Lektionen, Übungspool, Einstufung, Theorie-Beispiele und die 123 gleichwertigen Lösungen), davon 699 mit Ausgabevergleich |
