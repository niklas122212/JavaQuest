...
| `node Web/tests/lauf.mjs` | 31 Prüfungen der Web-Fassung: Musterlösungen, gleichwertige Lösungen, abgelehnter Unfug, Tipps, zweite Tipps, benannte Abweichungen, Bestehensgrenze, Karteikasten-Pausen, Ränge, Sterne, Score, Einstufung, Sicherung – dieselben Zahlen wie in den Swift- und Kotlin-Reihen |
