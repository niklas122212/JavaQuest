...
| Web-App (`Web/`), im Browser gegen die ausgelieferte Kursdatei | 685/685 Musterlösungen akzeptiert, 1433/1433 falsche Antworten abgelehnt. Barrierefreiheit über alle zehn Bildschirme geprüft: kein Bedienelement ohne Namen, keine Grafik ohne Beschreibung, jede Seite mit Überschrift; Farbkontraste nach WCAG AA gemessen (Knopfbeschriftung 4,55:1 statt zuvor 2,85:1); Tastaturkürzel über echte Tastendrücke durchgespielt. Gegen den Kern nachgerechnet und in allen Fällen gleich: Master Score (1000 / 109 / 363 / 0 in vier Beispielständen, inklusive Stufenfaktor 1,0/1,25/1,5), Sterne (69 % ★, 84,5 % ★★, 100 % ★★★), Ränge ab 0/150/350/600/850, Themenstatus (Stärke ab 75 % bei ≥ 3 Aufgaben, Lücke unter 55 % bei ≥ 2), Tagesserie (Lücke setzt zurück, Bestwert bleibt) und die Wiedervorlage-Faktoren (0,25 → 1 → 2). Einstufung über die Oberfläche durchgespielt: 0–5 richtige Antworten ergeben monoton steigende Ergebnisse und alle drei Einstiegsstufen; alte gespeicherte Stände bleiben vollständig erhalten |
...
| Windows-App: `./gradlew test` | 64 Tests bestanden (59 Logik/Speicherung, 5 Klick-Durchläufe der echten Oberfläche mit Screenshots) – darunter dieselben Werte für das verteilte Wiederholen wie auf Apple-Geräten |
