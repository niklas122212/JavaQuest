...
export function pruefungen(api, kurs, beispiele) {
  ...
  if (beispiele) {
    ...
    if (ausApp) {
      ergebnisse.push(pruefe(
        "App-Sicherung: 9 Antworten ohne Einstufung, 2 Lektionen, 3 fällige Lernziele, Score 27",
        ausApp.protokoll.length === 9 && bestanden(ausApp) === 2 && faellig(ausApp) === 3 && api.score(ausApp.lektionen) === 27,
